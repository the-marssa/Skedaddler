...
public class PlayerController : MonoBehaviour
{
    ...
    private bool RunActive => GameCore.Instance == null || GameCore.Instance.IsRunActive;
    ...
    {
        if (!RunActive) { addValue = 0f; return; }
    ...
    {
        if (!RunActive || controlsLocked || isJumping) return;
        isJumping = true;
        jumpT = 0f;
